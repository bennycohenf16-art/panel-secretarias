...
export default function Dashboard() {
  ...
  // ── Suscripción (estado y refresco viven en AuthContext) ──────────────────
  ...
  // ── Manejo del retorno desde Stripe (success_url apunta a /billing, pero por
  //    compatibilidad también se detecta aquí si el usuario llega a /) ────────
  useEffect(() => {
